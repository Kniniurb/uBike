...
public class Field {
   ...
   public Field(final Field field) {
      ...
      for (Object value : field.values) {
         if (value instanceof Byte) {
            ...
            this.values.add(Integer.valueOf((Integer) value));
         } else if (value instanceof Long) {
            this.values.add(Long.valueOf((Long) value));
         } else if (value instanceof Float) {
            this.values.add(Float.valueOf((Float) value));
         } else if (value instanceof Double) {
            this.values.add(Double.valueOf((Double) value));
   ...
   private Object getValueInternal(int fieldArrayIndex, SubField subField) {
      ...
      if (value instanceof Number) {
         ...
         if ((scale != 1) || (offset != 0)) {
            return Double.valueOf(((Number) value).doubleValue() / scale - offset);
         }
      }
